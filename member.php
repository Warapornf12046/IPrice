...
<head>
    ...
    <style>
    .header {
        background-size: cover; /* This will make the background cover the entire header */
        /* If you want the background to be smaller, you can adjust the background-size property */
        /* For example, you can set it to a specific size like this: */
        /* background-size: 50%; */
    }
</style>
            ...
            <div class="single-contact-box">
                <form method='post' action='OrderService.php'>
                    ...
                    <table class="table">
                        ...
                        $sql = "SELECT `Member_Id`, `Member_Name`, `Member_Tel` FROM `member` LIMIT $limit OFFSET $offset";
