    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <form action="promotion.php" method="post" onsubmit="return confirm('ยืนยันการส่งข้อมูล ??')">
                ...
                <input class="btn" type="button" onclick="document.location='member3.php'" value="ย้อนกลับ">
                <input class="btn " type="button" name="" onclick="document.location='receiptpromotion.php'" value="ใบเสร็จ">
            </div>
        </div>
    </section>
