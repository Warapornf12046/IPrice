            ...
            <div class="single-contact-box">
                ...
                if ($hasProductData) { // ถ้ามีข้อมูลสินค้าอย่างเดียว
                    ...
                    if ($rowProduct['Kg_Rice_bran']) {
                        ...
                        echo "<div class='item' style='text-align: center;'>รำ  จำนวน: " . $rowProduct['Kg_Rice_bran'] . " kg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";
                    ...
                    if ($rowProduct['Kg_Husk']) {
                        ...
                        echo "<div class='item' style='text-align: center;'>แกลบ  จำนวน: " . $rowProduct['Kg_Husk'] . " kg&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    ...
                    if ($rowProduct['Kg_Rice_chunks']) {
                        ...
                        echo "<div class='item' style='text-align: center;'>ข้าวท่อน  จำนวน: " . $rowProduct['Kg_Rice_chunks'] . " kg&nbsp;&nbsp;&nbsp;";
                    ...
                    if ($rowProduct['Kg_Broken_rice']) {
                        ...
                        echo "<div class='item' style='text-align: center;'>ข้าวปลาย  จำนวน: " . $rowProduct['Kg_Broken_rice'] . " kg&nbsp;&nbsp;";
                        echo "ราคารวม: " . $kg_product4_price . " บาท</div>";
                    }
                    // ราคารวมทั้งหมด
