    ...
    <div class="container">
        ...
        if ($result_product !== false && $result_product->num_rows > 0) {
            ...
            if ($row_product['Kg_Rice_bran']) {
                ...
                echo "<tr>";
                echo "<td>รำ</td>";
                echo "<td>" . $row_product['Kg_Rice_bran'] . " กก.</td>";
            ...
            if ($row_product['Kg_Husk']) {
                ...
                echo "<tr>";
                echo "<td>แกลบ</td>";
                echo "<td>" . $row_product['Kg_Husk'] . " กก.</td>";
            ...
            if ($row_product['Kg_Rice_chunks']) {
                ...
                echo "<tr>";
                echo "<td>ข้าวท่อน</td>";
                echo "<td>" . $row_product['Kg_Rice_chunks'] . " กก.</td>";
            ...
            if ($row_product['Kg_Broken_rice']) {
                ...
                echo "<tr>";
                echo "<td>ข้าวปลาย</td>";
                echo "<td>" . $row_product['Kg_Broken_rice'] . " กก.</td>";
